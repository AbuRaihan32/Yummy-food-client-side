  ...
  return (
    <>
      <div className="text-center mt-12">
        <h1 className="text-4xl font-bold mb-7">What Customer Says</h1>
        <p className="px-5 md:mx-32">
        Discover genuine feedback from our patrons in What Our Customers Say. Hear their experiences firsthand from savory bites to delightful ambiance. Join us in celebrating the joy of food through the voices of our valued guests.
        </p>
      </div>
        ...
        <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md border-[1px] border-green-400">
          <div className="flex justify-between p-4">
            <div className="flex space-x-4">
              <div>
                <img
                  src={'https://i.ibb.co/YQcv0Bv/pexels-vika-glitter-1648377.jpg'}
                  alt=""
